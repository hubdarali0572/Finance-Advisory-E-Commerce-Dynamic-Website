...
@section('content')
    ...
    <h4 class="card-title mb-2">Modify Subscription Plan</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6  col-lg-6 mb-3">
                                ...
                                <input id="title" class="form-control border border-secondary" name="title"
                                    value="{{ old('title', $subscription->title) }}" type="text"
                             ...
                             <div class="col-12 col-md-6  col-lg-6 mb-3">
                                ...
                                <input id="price" class="form-control border border-secondary" name="post_number"
                                    value="{{ old('post_number', $subscription->post_number) }}" type="post_number" placeholder="Enter post Number (e.g., 0.00)"
                                    required>
                            </div>
                            ...
                            <div class="col-12 col-md-6  col-lg-6 mb-3">
                                ...
                                <input id="price" class="form-control border border-secondary" name="price"
                                    value="{{ old('price', $subscription->price) }}" type="number"
                                    placeholder="Enter Price (e.g., 0.00)" required>
                            </div>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-3">
                                ...
                                <div class="input-group border border-dark rounded">
                                    <input type="text" class="form-control flatpickr" name="start_date" id="start_date"
                                        placeholder="Enter  Start Date" data-input value="{{ old('start_date', $subscription->start_date)}}">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-3">
                                ...
                                <div class="input-group border border-dark rounded">
                                    <input type="text" class="form-control flatpickr" name="end_date" id="end_date"
                                        placeholder="EnterEnd Date" data-input value="{{ old('end_date', $subscription->end_date)}}">
                                    <span class="input-group-text input-group-addon" data-toggle><i
                                            data-feather="calendar"></i></span>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 col-lg-6 mb-3">
                                ...
                                <select name="is_active" id="status" class="form-control border border-secondary">
                                    <option value="1" {{ old('is_active', $subscription->is_active ?? 1) == 1 ? 'selected' : '' }}>
                                        Active
                                    </option>
                                    <option value="0" {{ old('is_active', $subscription->is_active ?? 1) == 0 ? 'selected' : '' }}>
                                        Inactive
                                    </option>
                                </select>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <textarea class="form-control border border-secondary" name="description"
                                            ...
                                            rows="10">{{ old('description', $subscription->description) }}</textarea>
                                    </div>
                                </div>
                            </div>
