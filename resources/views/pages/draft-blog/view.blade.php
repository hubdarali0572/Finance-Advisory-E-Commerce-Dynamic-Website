                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-12">
                            <div class="description-card">
                                <div class="description-header"><i class="fas fa-file-alt me-2"></i>Blog Short Description
                                </div>
                                <div class="description-content">
                                    {!! $blog->short_description ?? '<p class="text-muted">N/A</p>' !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="description-card">
                                <div class="description-header"><i class="fas fa-file-alt me-2"></i>Blog Content</div>
                                <div class="description-content">
                                    {!! $blog->content ?? '<p class="text-muted">N/A</p>' !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="description-card">
                                ...
                                <div class="description-content">
                                    {!! $blog->seo_description ?? '<p class="text-muted">N/A</p>' !!}
                                </div>
                            </div>
                        </div>
                    </div>
