...
@section('content')
    ...
    <nav class="page-breadcrumb">
        <h4 class="card-title">Add The Blog</h4>
    </nav>
    <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-3">
                                ...
                                <select id="category_id" name="category_id" class="form-select border border-dark">
                                    <option value="" disabled {{ old('category_id') ? '' : 'selected' }}>- Please Select
                                        Category -</option>
                            ...
                            <div class="col-12 col-md-6 col-lg-6 mb-3">
                                <label for="title" class="form-label"><strong>Blog Title </strong><span
                                        style="color:red;">*</span></label>
                            ...
                            <div class="col-12 col-md-6 col-lg-6 mb-3">
                                <label for="slug" class="form-label"><strong>Blog Slug </strong><span
                                        style="color:red;">*</span></label>
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6 mb-3">
                                <label for="date" class="form-label"><strong>Blog Date</strong><span
                                        style="color:red;">*</span></label>
                            ...
                            <div class="col-12 col-md-6 col-lg-6  mb-3">
                                <label for="publish_status" class="form-label"><strong>Blog Status</strong></label>
                                <select name="publish_status" id="publish_status" class="form-control border border-secondary">
                                    <option value="" disabled {{ old('publish_status') ? '' : 'selected' }}>-- Select Status --
                                    </option>
                                    <option value="published" {{ old('publish_status', 'published') == 'published' ? 'selected' : '' }}>Published
                                    </option>
                                    <option value="draft" {{ old('publish_status') == 'draft' ? 'selected' : '' }}>Draft
                                    </option>
                                </select>
                            ...
                            <div class="row mt-3 justify-content-center">
                                ...
                                {{-- <div class="col-auto">
                                    <button type="submit" name="action" value="draft" class="btn text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 33%, #f093fb 66%, #f5576c 100%);
                                        border-radius:40px; width:90px">
                                        Draft
                                    </button>
                                </div> --}}
                                <div class="col-auto">
                                    <button type="submit" name="action" value="submit" class="btn text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 33%, #f093fb 66%, #f5576c 100%);
                                        border-radius:40px; width:90px">
                                        Submit
                                    </button>
                                </div>
