                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6  mb-3">
                                ...
                                <select name="publish_status" id="publish_status"
                                    ...
                                    <option value="" disabled {{ old('publish_status',$blog->publish_status) ? '' : 'selected' }}>-- Select Status
                                        --
                                    </option>
                                    <option value="published" {{ old('publish_status', 'published') == 'published' ? 'selected' : '' }}>Published
                                    </option>
                                    <option value="draft" {{ old('publish_status',$blog->publish_status) == 'draft' ? 'selected' : '' }}>Draft
                                    </option>
                                </select>
                            ...
                            <div class="row mt-3 justify-content-center">
                                ...
                                <div class="col-auto">
                                    <button type="submit" class="btn text-white"
                                        style="background: linear-gradient(135deg, #667eea 0%, #764ba2 33%, #f093fb 66%, #f5576c 100%);border-radius:40px; width:90px">Update</button>
                                </div>
                            </div>
