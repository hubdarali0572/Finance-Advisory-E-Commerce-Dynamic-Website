...
@section('content')
    ...
    <h4 class="card-title mb-2">Edit the Article </h4>
            ...
            <div class="card w-100 text-center p-2" style="height: 350px;">
                @if($category->file_path && file_exists(public_path('assets/category/video/' . $category->file_path)))
                    <video width="100%" height="100%" controls style="object-fit: cover;">
                        <source src="{{ asset('assets/category/video/' . $category->file_path) }}" type="video/mp4">
        ...
        <div class="col-md-4 d-flex align-items-stretch">
            <div class="card w-100 text-center p-2" style="height: {{ $previewHeight }};">
                @if($category->image_path && file_exists(public_path('assets/category/image/' . $category->image_path)))
                    <img src="{{ asset('assets/category/image/' . $category->image_path) }}" alt="Image"
            ...
            <div class="card w-100 text-center p-2" style="height: {{ $previewHeight }};">
                @if($category->audio_path && file_exists(public_path('assets/category/audio/' . $category->audio_path)))
                    <audio controls style="width: 100%; margin-top: 40px;">
                        <source src="{{ asset('assets/category/audio/' . $category->audio_path) }}" type="audio/mpeg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-lg-6 mb-3">
                                ...
                                <input type="text" name="name" id="name" class="form-control border border-secondary"
                                    value="{{ old('name', $category->name) }}" placeholder="Please Enter the Name">
                            </div>

                            <div class="col-12 col-md-6 col-lg-6 mb-3">
                                <label for="title" class="form-label">Title <span style="color:red;">*</span></label>
                                <input id="title" class="form-control border border-secondary" name="title"
                                    value="{{ old('title', $category->title) }}" type="text"
                            ...
                            <div class="col-12 col-md-6 col-lg-6  mb-3">
                                ...
                                <input id="seo_title" class="form-control border border-secondary" name="seo_title"
                                    value="{{old('seo_title', $category->seo_title)}}" type="text"
                            ...
                            <div class="col-12 col-md-6 col-lg-6 mb-3">
                                ...
                                <input id="seo_keywords" class="form-control border border-secondary" name="seo_keywords"
                                    value="{{old('seo_keywords', $category->seo_keywords)}}" type="text"
                            ...
                            <div class="col-12 col-md-12 col-lg-12 mb-3">
                                ...
                                <textarea name="tags" id="tags" class="form-control border border-secondary" rows="3"
                                    placeholder="Please enter tags, separated by commas">{{ old('tags', implode(',', json_decode($category->tags ?? '[]', true))) }}</textarea>
                            </div>
