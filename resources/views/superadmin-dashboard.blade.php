...
@section('content')
    ...
    <div class="dashboard-container">
        ...
        <div class="cards-grid">
            <!-- Categories Card -->
            <a href="{{ route('users.index') }}" class="stat-card card-cyan">
                <div class="card-header">
                    <div class="card-label text-white"> USERS</div>
                    <div class="card-icon"><i class="fa-solid fa-users"></i>
                    </div>
                </div>
                <div class="card-footer">
                    <div class="card-value text-white">{{ $usersTotal }}</div>
            ...
            <!-- Subcategories Card -->
            <a href="{{ route('subscriptions.index') }}" class="stat-card card-orange">
                <div class="card-header">
...
@push('custom-scripts')
    ...
    <script>
        ...
        if ($('#apexPie').length) {
            var pieOptions = {
                chart: { height: 300, type: "donut", foreColor: colors.bodyColor, background: colors.cardBg, toolbar: { show: false } },
                colors: [colors.primary, colors.danger, colors.warning],
